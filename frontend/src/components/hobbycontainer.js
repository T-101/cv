...
export default class HobbyContainer extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            stateRoute: '',
    ...
    async componentDidMount() {
        const url = window.location.protocol + '//' + window.location.hostname + ':8000/api/v1/hobby/hobbies/';
                        ...
                        <div className="col-12">
                            ...
                            <div className="card mb-3">
                                ...
                                {this.state.data ? this.state.data.map((dataitem, d) => {
                                    return (<DetailDataRow key={d} dataitem={dataitem}/>)
                                }) : null}
